...
//using GameDefinitions.math;

//namespace VisualizerLibrary
//{
//    public class MatrixCalculator
//    {
//        public static Matrix3x2F CreateMatrix(PointF[] SourcePoints, RectangleF DestPoints)
//        {
//            Matrix mtx = new Matrix(DestPoints, SourcePoints);
//            mtx.Invert();
//            return Convert(mtx);
//        }

//        public static Matrix3x2F Convert(Matrix mtx)
//        {
...
//        public static Matrix Convert(Matrix3x2F m)
//        {
//            Matrix mtx = new Matrix(m.M11, m.M12, m.M21, m.M22, m.M31, m.M32);
//            return mtx;
//        }

//        public static Matrix3x2F Scale(Matrix3x2F Current, float ScaleX, float ScaleY, MatrixOrder Order)
//        {
...
//        public static Matrix3x2F Rotate(Position2D Center, Matrix3x2F Current, float angle, MatrixOrder Order)
//        {
//            Matrix mtx = Convert(Current);
...
//            return Convert(mtx);
//        }
//        internal static Matrix3x2F Translate(Matrix3x2F Current, float OffsetX, float OffsetY, MatrixOrder Order)
//        {
//            Matrix mtx = Convert(Current);
