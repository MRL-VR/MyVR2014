...
namespace MRL.CustomMath
{
    ...
    public class Vector3 : Vector
    {
        ...
        public static implicit operator Pose2D(Vector3 p)
        {
            return new Pose2D(p.X, p.Y, 0f);
        }
        ...
        public Vector3(string vals)
            : base(vals)
        {
        }

        public Vector3(Vector source)
            : base(source)
        {
        }
